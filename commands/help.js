...
module.exports = {
	name: 'help',
	description:
		':helmet_with_cross: Get a list of all my commands, or get help with a specific command',
	aliases: ['commands'],
	usage: '[command name]',
	cooldown: 2,
	execute(props) {
		...
		if (!args.length) {
			...
			return msg.author
				...
				.catch((err) => {
					...
					msg.reply(
						"I'm having trouble sending you a DM. Do you have DMs disabled?"
					)
				})
		}
		...
		embed.setTitle(`:helmet_with_cross: Help: ${prefix}${command.name}`)
